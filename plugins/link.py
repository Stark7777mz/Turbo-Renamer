...
from helper_funcs.display_progress1 import progress_for_pyrogram


@pyrogram.Client.on_message(pyrogram.Filters.command(["j"]))
async def get_link(bot, update):
    if update.from_user.id in Config.BANNED_USERS:
        ...
        return
    TRChatBase(update.from_user.id, update.text, "j")
